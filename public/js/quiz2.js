...
const quiz2 = async ()=>{
    ...
    const draggables = [
        ...
        {
            name: 'jovian',
            url: 'http://localhost/img/quiz2/jovian_planets.png',
            x: 1611,
            y: 940,
            initX: 1611,
            initY: 940,
        ...
        {
            name: 'terrestial',
            url: 'http://localhost/img/quiz2/terrestial_planets.png',
            x: 1545,
            y: 858,
            initX: 1545,
            initY: 858,
    ...
    const drawBg=async()=>{
        const canvas = bg;
        canvas.addItem(new CanvasImage(await image.load('http://localhost/img/quiz2/bg.jpg'), 0, 0, 1920, 1080));
        canvas.draw();
    }
