...
const quiz2 = async (fg, mid, bg, image, submitAnswer)=>{
    ...
    const draggables = [
        {
            name: 'uranus',
            url: 'https://emandeguzman.github.io/ziel/img/journey/uranus-cropped.png',
            x: 100,
            y: 890,
            initX: 100,
            initY: 890,
        ...
        {
            name: 'mars',
            url: 'https://emandeguzman.github.io/ziel/img/journey/mars-cropped.png',
            x: 270,
            y: 890,
            initX: 270,
            initY: 890,
        ...
        {
            name: 'saturn',
            url: 'https://emandeguzman.github.io/ziel/img/journey/saturn-cropped.png',
            x: 430,
            y: 890,
            initX: 430,
            initY: 890,
        ...
        {
            name: 'neptune',
            url: 'https://emandeguzman.github.io/ziel/img/journey/neptune-cropped.png',
            x: 710,
            y: 890,
            initX: 710,
            initY: 890,
        ...
        {
            name: 'mercury',
            url: 'https://emandeguzman.github.io/ziel/img/journey/mercury-cropped.png',
            x: 880,
            y: 890,
            initX: 880,
            initY: 890,
        ...
        {
            name: 'jupiter',
            url: 'https://emandeguzman.github.io/ziel/img/journey/jupiter-cropped.png',
            x: 1045,
            y: 890,
            initX: 1045,
            initY: 890,
        ...
        {
            name: 'venus',
            url: 'https://emandeguzman.github.io/ziel/img/journey/venus-cropped.png',
            x: 1210,
            y: 890,
            initX: 1210,
            initY: 890,
        ...
        {
            name: 'earth',
            url: 'https://emandeguzman.github.io/ziel/img/journey/earth.png',
            x: 1380,
            y: 890,
            initX: 1380,
            initY: 890,
        ...
        {
            name: 'jovian',
            url: 'https://emandeguzman.github.io/ziel/img/quiz2/jovian_planets.png',
            x: 1611,
            y: 940,
            initX: 1611,
            initY: 940,
        ...
        {
            name: 'terrestial',
            url: 'https://emandeguzman.github.io/ziel/img/quiz2/terrestial_planets.png',
            x: 1545,
            y: 858,
            initX: 1545,
            initY: 858,
    ...
    const drawBg=async()=>{
        const canvas = bg;
        canvas.addItem(new CanvasImage(await image.load('https://emandeguzman.github.io/ziel/img/quiz2/bg.jpg'), 0, 0, 1920, 1080));
        canvas.draw();
    }
